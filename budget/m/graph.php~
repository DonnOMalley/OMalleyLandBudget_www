...
<body>
	<CENTER>
		...
		<tr>
		<td>
		<a href="http://www.omalleyland.com/m/budget/createDebit.php" target="_blank">Create New Debit(s)</a>
		</td>
		<td>
		<a href="http://www.omalleyland.com/m/budget/createParentCategory.php" target="_blank">Add New Category</a>
		</td>
		</table>
		
		
		<form method="post" action="http://www.omalleyland.com/m/budget/graph.php">
			<table border=1>
				<tr>

...
<body>
	<CENTER>	
		...
		<TABLE>
			<TR>
				<TD valign="top">
					<a href='../graphs/last3months.php?mobile=1' target=_blank>
						<div id='ColumnChartLast3MonthsNoBills_div' class='graphdiv'></div>
					</a>
					<a href='../graphs/currentMonthNoBills.php?mobile=1' target=_blank>
						<div id='ColumnChartNoBills_div' class="graphdiv"></div>
					</a>
					<a href='../graphs/currentMonthBillsByPayee.php?mobile=1' target=_blank>
						<div id='ColumnChartBills_div' class="graphdiv"></div>
					</a>
					<?php
					echo"
					<a href='../graphs/categorySpendingByMonth.php?mobile=1&start_debit_month=" . $startMonth . "&start_debit_year=" . $startYear . "&end_debit_month=" . $endMonth . "&end_debit_year=" . $endYear . "' target=_blank>"
					?>
						<div id='ColumnChartCategorySpendingByMonth_div' class="graphdiv"></div>
					</a>
					<?php
					echo"
					<a href='../graphs/dollarsSpentByCategoryNoBills.php?mobile=1&start_debit_month=" . $startMonth . "&start_debit_year=" . $startYear . "&end_debit_month=" . $endMonth . "&end_debit_year=" . $endYear . "' target=_blank>"
					?>
						<div id='PieChartCategoryDollarsNoBills_div' class="graphdiv"></div>
					</a>
					<?php
					echo"
					<a href='../graphs/dollarsSpentByCategory.php?mobile=1&start_debit_month=" . $startMonth . "&start_debit_year=" . $startYear . "&end_debit_month=" . $endMonth . "&end_debit_year=" . $endYear . "' target=_blank>"
					?>

...
<html><head>
  ...
  <title>OMalleyLand Budget - Category Spending By Month</title>
...
<?php
	if($mobile==1) {
		echo "<div id='ColumnChartCategorySpendingByMonth_div' class='mobilegraphdiv'></div>";
	}
	else {
		echo "<div id='ColumnChartCategorySpendingByMonth_div' class='graphdiv'></div>";
	}
?>
